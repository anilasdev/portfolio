...
.bgimg {
    ...
    background-image: url('http://localhost/myprofile/images/me.jpg');
    min-height: 100%;
...
<div class="w3-main w3-padding-large" style="margin-left:40%">
  ...
  <header class="w3-container w3-center" style="padding:128px 16px" id="home">
    <h1 class="w3-jumbo"><b>I' am Anil Kumar</b></h1>
    <p>Software developer at Ecotree Solutions Pvt Ltd</p>
    ...
    <button class="w3-button w3-light-grey w3-padding-large w3-margin-top"><a style='text-decoration:none;' href="http://localhost/myprofile/resume.docx"
